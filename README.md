...
- Asegúrate de tener la [API de procesamiento analítico](https://github.com/EdwinAlexanderBernardinoMoran/analytical-processing-api) ejecutándose antes de iniciar este proyecto.# Frontend de análisis de datos basada en IA
